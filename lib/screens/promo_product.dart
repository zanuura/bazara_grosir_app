...
class PromoProductPage extends StatefulWidget {
  const PromoProductPage({super.key});

  @override
  State<PromoProductPage> createState() => _PromoProductPageState();
}

class _PromoProductPageState extends State<PromoProductPage> {
  @override
